...
get_shared_data <- function(user_fname,partner_fname){
  
  # user_data <- read.table("user_data/Andy_Girls/elo_df.txt",stringsAsFactors = FALSE)
  # partner_data <- read.table("user_data/Frank_Girls/elo_df.txt",stringsAsFactors = FALSE)
  # user_name <- "Andy"
  # partner_name <- "Frankie"
  # print("...")
  print(user_fname)
  print(partner_fname)
  user_data <- read.table(user_fname,
  ...
  partner_data <- read.table(partner_fname,
                             stringsAsFactors = FALSE)
  ...
  # saveRDS(shared_data,"shared_data.rds")
  colnames(shared_data) <- gsub(pattern = "\\.",
                                replacement = " ",
                                x = colnames(shared_data))
  return(shared_data)
}
